...
class QuestionGenerator {
  ...
  constructor() {
    this.qTypes = {
      "multiple": `Give me a multiple choice question with one or more correct options, topic: How to do a Docker deployment. Follow the next template:
      { "question": "",
      "options": [
        "",
        "",
      ...
      "single": `Give me a multiple choice question with a single correct answer, topic: How to do a Docker deployment. Follow the next template:
      { "question": "",
      "options": [
        "",
        "",
      ...
      "write": `Give me a free text question which has short text as answer, topic: Things realted to how a Docker deployment is done. Follow the next template:
      { "question": "",
      "answer": "" // try to make the answer be a maximum of three words
    }
      No additional text`,
